...
```
Error: locator.innerText: SyntaxError: Failed to execute 'evaluate' on 'Document': The string '//table[@id='customers']/tbody/tr[2]/td[]' is not a valid XPath expression.
...
Call log:
  - waiting for locator('//table[@id=\'customers\']/tbody/tr[2]/td[]')
